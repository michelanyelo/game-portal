    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row ">
            ...
            <div class="lg:ml-12 lg:mr-64 ">
                ...
                <p class="mt-12">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. A corporis, dicta dolor ipsam provident
                    quas quia saepe veritatis? Dolorem ea ipsam neque quis veritatis? Dolore laudantium provident quam
                    soluta vel.
                </p>
                <div class="mt-12">
                    <button
                        class="flex bg-blue-600 text-white font-semibold px-4 py-4 hover:bg-blue-800 rounded transition duration-300">
        ...
        <div class="similar-container mt-8 ">
            <x-heading-title>Juegos similares</x-heading-title>
            <div
